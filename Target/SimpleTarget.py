...
class SimpleTarget(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Simple Target Demo")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simple Target Demo")
        ...
        self.qtgui_waterfall_sink_x_0.set_update_time(0.00015)
...
def main(top_block_cls=SimpleTarget, options=None):
